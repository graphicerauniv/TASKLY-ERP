...
const DOMAIN_TABLES = Object.freeze({
  ...
  academicGroups: {
    ...
    columns: ['name', 'academicSession', 'universityId', 'collegeId', 'semester', 'isActive'],
  },
  academicSections: {
    table: 'academic_sections',
    columns: ['name', 'academicSession', 'semester', 'isActive'],
  },
  academicSets: {
    table: 'academic_sets',
    columns: ['name', 'academicSession', 'semester', 'groupId', 'sectionId', 'isActive'],
  },
  subjects: {
    table: 'subjects',
    columns: [
  ...
  faculties: {
    table: 'faculties',
    columns: ['code', 'name', 'email', 'universityId', 'collegeId', 'isActive'],
  },
  academicRooms: {
  ...
  studentAcademicAssignmentHistory: {
    table: 'student_academic_assignment_history',
    columns: [
      'studentAdmissionId',
      'academicSession',
      'semester',
  ...
  groupSubjectAssignments: {
    table: 'group_subject_assignments',
    columns: ['groupId', 'subjectId', 'academicSession', 'semester', 'requirement', 'status'],
  },
  timetableEntries: {
  ...
  timetableStructures: {
    table: 'timetable_structures',
    columns: ['timetableMasterId', 'name', 'academicSession', 'periodCount', 'isActive'],
  },
  timetablePeriods: {
