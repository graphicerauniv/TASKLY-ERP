...
export const FEE_SERVICE_CARDS: readonly FeeServiceCardViewModel[] = [
  ...
  { id: 'receipts', title: 'Receipts', description: 'Download verified payment receipts', image: `${ASSET}/documents.webp`, tone: 'green', route: '/student/fees/receipts' },
  { id: 'history', title: 'Payment History', description: 'Track successful, pending and failed payments', image: `${ASSET}/attendance.webp`, tone: 'orange', route: '/student/fees/history' },
