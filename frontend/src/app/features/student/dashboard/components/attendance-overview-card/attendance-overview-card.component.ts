...
import { AttendanceDashboardViewModel, DashboardWidgetState } from '../../models/student-dashboard-operational.model';
  ...
  template: `
    <article class="student-operational-card student-operational-card--attendance">
      <header class="student-operational-card__header">
        <span><svg lucideChartNoAxesCombined size="18" aria-hidden="true"></svg><strong>Attendance</strong></span>
      </header>
