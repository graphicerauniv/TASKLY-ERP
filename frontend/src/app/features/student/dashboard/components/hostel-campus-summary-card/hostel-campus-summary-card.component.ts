  ...
  template: `
    <article class="student-operational-card student-operational-card--secondary">
      <header class="student-operational-card__header">
        <span
          ><svg lucideBuilding2 size="18" aria-hidden="true"></svg
          ><strong>Hostel & campus</strong></span
        >
      </header>
      <erp-dashboard-widget-state
        [status]="state().status"
        title="Hostel allocation unavailable"
        message="Your room allocation will appear after secure student access is available."
      />
    </article>
  `,
