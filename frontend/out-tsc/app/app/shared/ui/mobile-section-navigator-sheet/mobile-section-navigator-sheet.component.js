...
function MobileSectionNavigatorSheetComponent_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵattribute("aria-label", ctx_r1.heading());
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("cdkTrapFocusAutoCapture", true);
    i0.ɵɵadvance(4);
    i0.ɵɵproperty("heading", ctx_r1.heading())("items", ctx_r1.items())("completedCount", ctx_r1.completedCount())("totalCount", ctx_r1.totalCount());
} }
export class MobileSectionNavigatorSheetComponent {
    ...
    heading = input('Application sections', ...(ngDevMode ? [{ debugName: "heading" }] : /* istanbul ignore next */ []));
    closed = output();
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MobileSectionNavigatorSheetComponent, selectors: [["erp-mobile-section-navigator-sheet"]], hostBindings: function MobileSectionNavigatorSheetComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        } }, inputs: { open: [1, "open"], items: [1, "items"], completedCount: [1, "completedCount"], totalCount: [1, "totalCount"], heading: [1, "heading"] }, outputs: { closed: "closed", sectionSelected: "sectionSelected" }, decls: 1, vars: 1, consts: [["role", "dialog", "aria-modal", "true", 1, "erp-mobile-section-sheet"], ["type", "button", "aria-label", "Close sections", 1, "erp-mobile-section-sheet__backdrop", 3, "click"], ["cdkTrapFocus", "", 1, "erp-mobile-section-sheet__panel", 3, "cdkTrapFocusAutoCapture"], ["aria-hidden", "true", 1, "erp-mobile-section-sheet__handle"], ["type", "button", "aria-label", "Close sections", 1, "erp-mobile-section-sheet__close", 3, "click"], ["lucideX", "", "size", "18", "aria-hidden", "true"], ["panelId", "mobile-application-sections", 3, "sectionSelected", "heading", "items", "completedCount", "totalCount"]], template: function MobileSectionNavigatorSheetComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵconditionalCreate(0, MobileSectionNavigatorSheetComponent_Conditional_0_Template, 7, 6, "div", 0);
        } if (rf & 2) {
