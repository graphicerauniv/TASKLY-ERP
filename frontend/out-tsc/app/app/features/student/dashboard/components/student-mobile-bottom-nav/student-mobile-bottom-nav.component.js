...
export class StudentMobileBottomNavComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: StudentMobileBottomNavComponent, selectors: [["erp-student-mobile-bottom-nav"]], decls: 17, vars: 2, consts: [["aria-label", "Student dashboard shortcuts", 1, "student-mobile-bottom-nav"], ["routerLink", "/student/dashboard", "routerLinkActive", "student-mobile-bottom-nav__item--active", 3, "routerLinkActiveOptions"], ["lucideHome", "", "size", "22", "aria-hidden", "true"], ["routerLink", "/student/academics", "routerLinkActive", "student-mobile-bottom-nav__item--active"], ["lucideBookOpen", "", "size", "22", "aria-hidden", "true"], ["routerLink", "/student/fees", "routerLinkActive", "student-mobile-bottom-nav__item--active"], ["lucideLayoutGrid", "", "size", "22", "aria-hidden", "true"], ["routerLink", "/student/profile", "routerLinkActive", "student-mobile-bottom-nav__item--active", "aria-label", "Open student profile"], ["lucideUserRound", "", "size", "22", "aria-hidden", "true"]], template: function StudentMobileBottomNavComponent_Template(rf, ctx) { if (rf & 1) {
