...
function DeleteAdmissionsComponent_Conditional_24_For_14_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵpipe(10, "date");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(11, "td")(12, "span", 25);
    i0.ɵɵtext(13);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(14, "td", 17)(15, "erp-compact-action-menu", 26);
...
function DeleteAdmissionsComponent_Conditional_24_ForEmpty_15_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(4, "No admission records match your search.");
    i0.ɵɵelementEnd()()();
} }
...
function DeleteAdmissionsComponent_Conditional_24_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementStart(0, "div", 16)(1, "table")(2, "thead")(3, "tr")(4, "th");
    i0.ɵɵtext(5, "Student");
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵrepeaterCreate(13, DeleteAdmissionsComponent_Conditional_24_For_14_Template, 16, 11, "tr", null, _forTrack0, false, DeleteAdmissionsComponent_Conditional_24_ForEmpty_15_Template, 5, 0, "tr");
    i0.ɵɵelementEnd()()();
    i0.ɵɵelementStart(16, "div", 18)(17, "span");
    i0.ɵɵtext(18);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(19, "div", 19)(20, "select", 20);
    ...
    i0.ɵɵrepeaterCreate(21, DeleteAdmissionsComponent_Conditional_24_For_22_Template, 2, 2, "option", 21, i0.ɵɵrepeaterTrackByIdentity);
    i0.ɵɵelementEnd();
...
function DeleteAdmissionsComponent_Conditional_25_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementStart(0, "erp-record-drawer", 29);
    i0.ɵɵlistener("closed", function DeleteAdmissionsComponent_Conditional_25_Template_erp_record_drawer_closed_0_listener() { i0.ɵɵrestoreView(_r6); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.preview.set(null)); });
    i0.ɵɵelementStart(1, "a", 30);
    i0.ɵɵtext(2, "Open application");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const item_r7 = ctx;
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("open", true)("title", item_r7.studentName || "Admission record")("fields", ctx_r0.detailFields(item_r7));
    i0.ɵɵadvance();
    i0.ɵɵproperty("routerLink", i0.ɵɵpureFunction1(4, _c0, item_r7._id));
} }
function DeleteAdmissionsComponent_Conditional_26_Template(rf, ctx) { if (rf & 1) {
    const _r8 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "erp-confirm-dialog", 31);
    i0.ɵɵlistener("cancelled", function DeleteAdmissionsComponent_Conditional_26_Template_erp_confirm_dialog_cancelled_0_listener() { i0.ɵɵrestoreView(_r8); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.cancelDelete()); })("confirmed", function DeleteAdmissionsComponent_Conditional_26_Template_erp_confirm_dialog_confirmed_0_listener() { i0.ɵɵrestoreView(_r8); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.confirmDelete()); });
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r9 = ctx;
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("open", true)("message", "You are permanently deleting " + (item_r9.studentName || item_r9.studentId || "this student record") + ". This cannot be undone.")("confirmLabel", ctx_r0.deleting() ? "Deleting\u2026" : "Delete permanently")("destructive", true);
} }
export class DeleteAdmissionsComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DeleteAdmissionsComponent, selectors: [["erp-delete-admissions"]], decls: 27, vars: 7, consts: [["eyebrow", "Admission management", "title", "Delete Admission", "description", "Find and permanently remove an incorrect or unwanted admission record.", "variant", "compact", "layout", "collection"], [1, "erp-warning-panel"], [1, "erp-warning-panel__icon"], ["lucideTriangleAlert", "", "aria-hidden", "true"], ["role", "status", 1, "erp-notice", "erp-notice--success"], ["role", "alert", 1, "erp-notice", "erp-notice--error"], [1, "erp-card", "erp-table-shell"], [1, "erp-table-toolbar"], [1, "erp-search-control"], ["lucideSearch", "", "size", "18", "aria-hidden", "true"], ["type", "search", "placeholder", "Search student name, Student ID, or status", 3, "input", "keyup.enter", "value"], ["type", "button", 1, "erp-button", "erp-button--secondary", 3, "click"], [1, "erp-loading-state"], ["description", "Verify the student and application before taking action.", "illustration", "applicationForm", "guidance", "Open the complete application to review submitted information and documents.", 3, "open", "title", "fields"], ["eyebrow", "Admission record", "title", "Delete this admission?", 3, "open", "message", "confirmLabel", "destructive"], [1, "erp-spinner"], [1, "erp-table-shell__scroll"], [1, "erp-table-shell__actions"], [1, "erp-pagination"], [1, "erp-pagination__pages"], ["aria-label", "Rows per page", 1, "erp-control", "erp-pagination__size", 3, "ngModelChange", "ngModel"], [3, "ngValue"], ["type", "button", "aria-label", "Previous page", 1, "erp-pagination__button", 3, "click", "disabled"], ["type", "button", "aria-current", "page", 1, "erp-pagination__button", "erp-pagination__button--active"], ["type", "button", "aria-label", "Next page", 1, "erp-pagination__button", 3, "click", "disabled"], [1, "erp-status"], [3, "selected", "items"], ["colspan", "4", 1, "erp-empty-state"], ["kind", "noResults", "size", "compact"], ["description", "Verify the student and application before taking action.", "illustration", "applicationForm", "guidance", "Open the complete application to review submitted information and documents.", 3, "closed", "open", "title", "fields"], ["drawer-actions", "", 1, "erp-button", "erp-button--primary", 3, "routerLink"], ["eyebrow", "Admission record", "title", "Delete this admission?", 3, "cancelled", "confirmed", "open", "message", "confirmLabel", "destructive"]], template: function DeleteAdmissionsComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵelementEnd()();
            i0.ɵɵconditionalCreate(25, DeleteAdmissionsComponent_Conditional_25_Template, 3, 6, "erp-record-drawer", 13);
            i0.ɵɵconditionalCreate(26, DeleteAdmissionsComponent_Conditional_26_Template, 1, 4, "erp-confirm-dialog", 14);
        } if (rf & 2) {
            let tmp_5_0;
            let tmp_6_0;
            i0.ɵɵadvance(9);
            ...
            i0.ɵɵadvance(2);
            i0.ɵɵconditional((tmp_5_0 = ctx.preview()) ? 25 : -1, tmp_5_0);
            i0.ɵɵadvance();
            i0.ɵɵconditional((tmp_6_0 = ctx.deleteTarget()) ? 26 : -1, tmp_6_0);
