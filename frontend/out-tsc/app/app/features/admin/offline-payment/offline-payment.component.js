...
function OfflinePaymentComponent_Conditional_7_ForEmpty_134_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelement(2, "erp-admin-illustration", 38);
    i0.ɵɵelementStart(3, "p");
    i0.ɵɵtext(4, "No completed payments found.");
    i0.ɵɵelementEnd()()();
} }
function OfflinePaymentComponent_Conditional_7_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵrepeaterCreate(132, OfflinePaymentComponent_Conditional_7_For_133_Template, 19, 12, "tr", null, _forTrack0, false, OfflinePaymentComponent_Conditional_7_ForEmpty_134_Template, 5, 0, "tr");
    i0.ɵɵelementEnd()()()();
} if (rf & 2) {
    let tmp_25_0;
    const item_r10 = ctx;
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(OfflinePaymentComponent, { className: "OfflinePaymentComponent", filePath: "frontend/src/app/features/admin/offline-payment/offline-payment.component.ts", lineNumber: 27 }); })();
