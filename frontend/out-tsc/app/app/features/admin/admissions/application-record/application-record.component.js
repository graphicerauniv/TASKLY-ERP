...
import { LucideArrowLeft, LucideBadgeCheck, LucideClipboardList, LucideFileText, LucidePencil, LucideRefreshCw, LucideUserRound, } from '@lucide/angular';
...
function ApplicationRecordComponent_Conditional_7_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(3, "Application record unavailable");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "p");
    i0.ɵɵtext(5);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(6, "button", 15);
    i0.ɵɵlistener("click", function ApplicationRecordComponent_Conditional_7_Template_button_click_6_listener() { i0.ɵɵrestoreView(_r2); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.load()); });
    i0.ɵɵnamespaceSVG();
    i0.ɵɵelement(7, "svg", 16);
...
function ApplicationRecordComponent_Conditional_8_Conditional_24_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 26)(1, "section", 27)(2, "header")(3, "div")(4, "h3");
    ...
    i0.ɵɵelementEnd()()();
    i0.ɵɵelementStart(8, "dl", 28)(9, "div")(10, "dt");
    ...
    i0.ɵɵtext(58);
    i0.ɵɵelementEnd()()()();
    i0.ɵɵelementStart(59, "aside", 29)(60, "section", 27)(61, "header")(62, "div")(63, "h3");
    i0.ɵɵtext(64, "Lifecycle");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(65, "p");
    i0.ɵɵtext(66, "Dates available from the current record.");
    i0.ɵɵelementEnd()()();
    i0.ɵɵelementStart(67, "dl", 30)(68, "div")(69, "dt");
...
function ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Conditional_5_For_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ɵ$index_326_r10 = ctx.$index;
    const subsection_r7 = i0.ɵɵnextContext(2).$implicit;
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate2("", subsection_r7.name, " ", ɵ$index_326_r10 + 1);
    i0.ɵɵadvance(2);
...
function ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Conditional_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵrepeaterCreate(0, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Conditional_5_For_1_Template, 6, 2, "article", 42, i0.ɵɵrepeaterTrackByIndex, false, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Conditional_5_ForEmpty_2_Template, 2, 0, "p", 40);
} if (rf & 2) {
    const subsection_r7 = i0.ɵɵnextContext().$implicit;
...
function ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "section", 39)(1, "header")(2, "h4");
    i0.ɵɵtext(3);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(5, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Conditional_5_Template, 3, 1)(6, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Conditional_6_Template, 4, 1, "dl", 41);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "header")(1, "span", 37);
    i0.ɵɵnamespaceSVG();
    ...
    i0.ɵɵtext(7);
    i0.ɵɵelementEnd()()();
    i0.ɵɵrepeaterCreate(8, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_For_9_Template, 7, 3, "section", 39, _forTrack0, false, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Conditional_7_ForEmpty_10_Template, 2, 0, "div", 40);
} if (rf & 2) {
...
function ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 31)(1, "nav", 33)(2, "span");
    i0.ɵɵtext(3, "Form sections");
    i0.ɵɵelementEnd();
    i0.ɵɵrepeaterCreate(4, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_For_5_Template, 5, 5, "button", 34, _forTrack0);
    i0.ɵɵelementEnd();
...
function ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelement(1, "erp-admin-illustration", 14);
    i0.ɵɵelementStart(2, "h2");
    i0.ɵɵtext(3, "No application snapshot");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "p");
    i0.ɵɵtext(5, "This record does not contain a saved form structure to display.");
    i0.ɵɵelementEnd()();
} }
function ApplicationRecordComponent_Conditional_8_Conditional_25_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵconditionalCreate(0, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_0_Template, 8, 1, "div", 31)(1, ApplicationRecordComponent_Conditional_8_Conditional_25_Conditional_1_Template, 6, 0, "div", 32);
} if (rf & 2) {
    const record_r4 = i0.ɵɵnextContext();
...
function ApplicationRecordComponent_Conditional_8_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "section", 6)(1, "header", 17)(2, "span", 18);
    i0.ɵɵnamespaceSVG();
    i0.ɵɵelement(3, "svg", 19);
    i0.ɵɵelementEnd();
    i0.ɵɵnamespaceHTML();
    ...
    i0.ɵɵtext(10);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(11, "div", 20)(12, "span", 21);
    i0.ɵɵtext(13);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(14, "small");
    i0.ɵɵtext(15);
    i0.ɵɵelementEnd()()();
    i0.ɵɵelementStart(16, "nav", 22)(17, "a", 23);
    i0.ɵɵnamespaceSVG();
    ...
    i0.ɵɵnamespaceSVG();
    i0.ɵɵelement(21, "svg", 24);
    i0.ɵɵtext(22, " Application ");
    i0.ɵɵelementEnd()();
    i0.ɵɵnamespaceHTML();
    i0.ɵɵelementStart(23, "div", 25);
    i0.ɵɵconditionalCreate(24, ApplicationRecordComponent_Conditional_8_Conditional_24_Template, 106, 16, "div", 26)(25, ApplicationRecordComponent_Conditional_8_Conditional_25_Template, 2, 1);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const record_r4 = ctx;
    const ctx_r2 = i0.ɵɵnextContext();
...
export class ApplicationRecordComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ApplicationRecordComponent, selectors: [["erp-application-record"]], decls: 9, vars: 3, consts: [["eyebrow", "Admissions / Application record", "description", "Read-only application evidence and lifecycle context.", "variant", "compact", 3, "title"], ["page-actions", "", 1, "application-record__page-actions"], ["routerLink", "/admin/admissions/applications", 1, "erp-button", "erp-button--secondary"], ["lucideArrowLeft", "", "size", "16", "aria-hidden", "true"], ["aria-label", "Loading application record", 1, "erp-card", "application-record__loading"], ["role", "alert", 1, "erp-card", "erp-empty-panel"], [1, "erp-card", "application-record__shell"], [1, "erp-button", "erp-button--primary", 3, "routerLink"], [1, "erp-button", "erp-button--secondary", 3, "routerLink"], ["lucidePencil", "", "size", "15", "aria-hidden", "true"], ["lucideClipboardList", "", "size", "16", "aria-hidden", "true"], [1, "erp-skeleton", "application-record__skeleton-title"], [1, "erp-skeleton", "application-record__skeleton-tabs"], [1, "erp-skeleton"], ["kind", "applicationForm"], ["type", "button", 1, "erp-button", "erp-button--secondary", 3, "click"], ["lucideRefreshCw", "", "size", "15", "aria-hidden", "true"], [1, "application-record__identity"], [1, "application-record__identity-icon"], ["lucideUserRound", "", "size", "21", "aria-hidden", "true"], [1, "application-record__identity-status"], [1, "erp-status"], ["aria-label", "Application record sections", 1, "application-record__tabs"], ["queryParamsHandling", "merge", 3, "routerLink", "queryParams"], ["lucideFileText", "", "size", "16", "aria-hidden", "true"], [1, "application-record__content"], [1, "application-record__overview"], [1, "application-record__section"], [1, "application-record__facts"], [1, "application-record__side"], [1, "application-record__timeline"], [1, "application-record__application"], [1, "erp-empty-panel"], ["aria-label", "Application form sections"], ["type", "button", 3, "is-active"], [1, "application-record__evidence"], ["type", "button", 3, "click"], [1, "application-record__evidence-icon"], ["lucideBadgeCheck", "", "size", "18", "aria-hidden", "true"], [1, "application-record__subsection"], [1, "application-record__no-data"], [1, "application-record__responses"], [1, "application-record__repeat-entry"]], template: function ApplicationRecordComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵelementEnd();
            i0.ɵɵconditionalCreate(6, ApplicationRecordComponent_Conditional_6_Template, 8, 0, "section", 4)(7, ApplicationRecordComponent_Conditional_7_Template, 9, 1, "section", 5)(8, ApplicationRecordComponent_Conditional_8_Template, 26, 25, "section", 6);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            let tmp_0_0;
            let tmp_1_0;
