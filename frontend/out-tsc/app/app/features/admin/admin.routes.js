...
export const ADMIN_ROUTES = [
    ...
    },
    {
        ...
        loadComponent: () => import('./layout/admin-shell.component').then((component) => component.AdminShellComponent),
        children: [
            {
                path: 'dashboard',
            ...
            { path: 'academics', pathMatch: 'full', redirectTo: 'academics/groups' },
            {
                ...
                loadComponent: () => import('./exams/exam-schedules.component').then((component) => component.ExamSchedulesComponent),
            },
            {
                path: 'exams/shifts',
                loadComponent: () => import('./exams/exam-shifts.component').then((component) => component.ExamShiftsComponent),
            },
            {
                path: 'exams/subject-schedules',
                loadComponent: () => import('./exams/exam-subject-schedules.component').then((component) => component.ExamSubjectSchedulesComponent),
            },
            {
                path: 'exams/eligibility',
                loadComponent: () => import('./exams/exam-eligibility.component').then((component) => component.ExamEligibilityComponent),
            },
            ...
            ...[
                ...
                loadComponent: () => import('./hostel-management/hostel-management.component').then((component) => component.HostelManagementComponent),
                data: { section },
            })),
            {
                path: 'fees',
            ...
            {
                path: 'fees/overview',
                loadComponent: () => import('./fee-management/finance-overview.component').then((component) => component.FinanceOverviewComponent),
            },
            {
                path: 'fees/progression',
                canDeactivate: [(page) => !page.saving()],
                loadComponent: () => import('./fee-progression/fee-progression.component').then((component) => component.FeeProgressionComponent),
            },
            {
                path: 'fees/schedules',
                loadComponent: () => import('./fee-schedules/fee-schedules.component').then((component) => component.FeeSchedulesComponent),
            },
            { path: 'fees/scholarships', pathMatch: 'full', redirectTo: 'fees/scholarships/view' },
            {
                path: 'fees/scholarships/view',
                loadComponent: () => import('./scholarships/scholarships.component').then((component) => component.ScholarshipsComponent),
                data: { mode: 'view' },
            },
            {
            ...
            ...['overview', 'payments', 'credits', 'discounts'].map((section) => ({
                ...
                data: { section },
                loadComponent: () => import('./accounts/accounts.component').then((component) => component.AccountsComponent),
            })),
            ...[
                ...
                path: `fees/${path}`,
                loadComponent: () => import('./fee-management/fee-management.component').then((component) => component.FeeManagementComponent),
                data: { section, mode },
            })),
            ...[
                ['books', 'books/create'],
            ...
            ...[
                ...
                loadComponent: () => import('./master-data/master-data.component').then((component) => component.MasterDataComponent),
                data: { mode },
            })),
            {
            ...
            {
                path: 'form-builder',
                loadComponent: () => import('./form-builder/form-builder.component').then((component) => component.FormBuilderComponent),
            },
            {
                path: 'admission/student',
                data: { embedded: true },
                loadComponent: () => import('../student/admission/dynamic-admission.component').then((component) => component.DynamicAdmissionComponent),
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./admissions/forms-library/forms-library.component').then((component) => component.FormsLibraryComponent),
            },
            {
                path: 'admissions/forms/:formId/applications',
                title: 'Student applications',
                loadComponent: () => import('./admissions/admissions.component').then((component) => component.AdmissionsComponent),
            },
            {
                path: 'applications/:purpose/:formId',
                title: 'Application submissions',
                loadComponent: () => import('./application-submissions/application-submissions.component').then((component) => component.ApplicationSubmissionsComponent),
            },
            {
                path: 'forms/:formId/fill',
                title: 'Fill form',
                loadComponent: () => import('../public-form/public-form.component').then((component) => component.PublicFormComponent),
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./student-scholarships/student-scholarships.component').then((component) => component.StudentScholarshipsComponent),
            },
            {
                path: 'admissions/:admissionId/offline-payment',
                title: 'Make offline payment',
                loadComponent: () => import('./offline-payment/offline-payment.component').then((component) => component.OfflinePaymentComponent),
            },
            {
                path: 'admissions/:admissionId/edit',
                title: 'Edit application',
                canDeactivate: [unsavedChangesGuard],
                loadComponent: () => import('./admissions/application-editor/application-editor.component').then((component) => component.ApplicationEditorComponent),
            },
            {
                path: 'admissions/applications/:admissionId/review',
                title: 'Application review',
                loadComponent: () => import('./admissions/application-review/application-review.component').then((component) => component.ApplicationReviewComponent),
            },
            {
                path: 'admissions/applications/:admissionId',
                title: 'Application record',
                loadComponent: () => import('./admissions/application-record/application-record.component').then((component) => component.ApplicationRecordComponent),
            },
            {
            ...
            },
            {
                ...
                loadComponent: () => import('./student-promotions/student-promotions.component').then((component) => component.StudentPromotionsComponent),
            },
            {
                path: 'admissions',
                pathMatch: 'full',
            ...
            },
            {
                ...
                loadComponent: () => import('./delete-admissions/delete-admissions.component').then((component) => component.DeleteAdmissionsComponent),
            },
            {
